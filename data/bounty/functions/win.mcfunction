...
title @a actionbar ["",{"selector":"@a[tag=winner,limit=1]","color":"green","bold":true},{"text":" won with "},{"text":"$","color":"gold","bold":true},{"score":{"name":"@s","objective":"coins"},"color":"yellow","bold":true}]
